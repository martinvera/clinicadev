...
public class RegistrarDocFromUnilabRequest {
    ...
    private @Valid DocumentCreateRequest request;

    @Data
    @Validated
    public static class DocumentCreateRequest {
        private @Valid Cabecera cabecera;
        private @Valid List<@Valid Detalle> detalle;
    }
    ...
    public static class Cabecera {
        ...
        @NotBlank(message = "No existe numero de encuentro")
        ...
        @NotBlank(message = "No existe pdf en base64")
