...
import static pe.com.ci.sed.document.util.GenericUtil.getHeader;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return buildResponseEntity(getBody(error, null), error.getStatus());
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, WebRequest request) {
        ...
        if (Objects.nonNull(ex.getRequiredType())) {
            ...
            error.setMensaje("parametros nulos");
            return buildResponseEntity(getBody(error, getHeaders(request)), error.getStatus());
        }
    ...
    protected ResponseEntity<Object> handleClinicalRecordException(DocumentException ex, WebRequest request) {
